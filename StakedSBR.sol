...
contract StakedSnowbear is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Snowbear", "sSBR", 9) ERC20Permit() {
    ...
    /**
        @notice increases StakedSnowbear supply to increase staking balances relative to profit_
